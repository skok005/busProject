...
$(document).ready(function () {
    ...
    $('#Adults, #Students').change(function () {
        ...
        $('#Fare').val(adultNum*18000  + studentNum*9000 ).change();
    });
    ...
    $('#ConfirmSeat').unbind('click').bind('click', function () {
        ...
        if ($('#Seats').val() == '' || $('#Seats').val() == 0) {
            ...
            $form.append($('<input/>',{type:'hidden', name:'busFare', value:$fare}));
            ...
            $form.append($('<input/>',{type:'hidden', name:'prefare', value:$prefare})); 
        ...
        if (data =="2"){
        	...
        	"&userid="+UserName+"&seatcount="+UserCount+"&seatSel="+idList+"&routeno="+$routeno+"&timeno="+$timeno+"&fare="+$fare+
